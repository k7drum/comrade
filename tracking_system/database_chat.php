...
$sql = "SELECT * FROM database_chats";
...
if(move_uploaded_file($_FILES['uploaded_file']['tmp_name'], $target)) {
    ...
    $sql="INSERT INTO database_chat(uploaded_file, message, date_time, student_id)
...
<body>
  ...
  <tr> 
    ...
    <form method="post" name="formUserReg" id="formUserReg" action="database_chat.php" enctype="multipart/form-data" >
    <?php if (isset($errors)) 
        { 
        ?>
	    <p><?php echo $errors; ?></p>
	...
	<tbody>
		...
		$message = mysqli_query($con, "SELECT * FROM database_chat where student_id=$user_id");
