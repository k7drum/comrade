...
?>
	...
	$result = mysqli_query($con, $sql) or die("Error when tryin to delete note.");
		...
		echo "<script>
		alert('success');
		window.location.href='adDetails.php';
		</script>";
	}//end if
}//end if
  ...
  <div id="main">
						<tr> 
							 <td class="contentArea"> 
								<form method="post" name="formUserReg" id="formUserReg" action="adDetails.php">
									<p>&nbsp;</p>
		...
		?>
								...
								<!--calling entity of committee_member to table -->
								  ...
								  <td width ="200" align="center"><?php echo ucwords($email); ?></td>
								   ...
								   <td  align="center"><a href="editStaff.php?id=<?php echo $row['id']?>">Edit</a> /<a href="editStaff.php?id='<?php echo $id?>'"onclick="return confirm('Are you sure?')">Delete</a> 
								</td>
								</tbody>
