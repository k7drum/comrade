...
if(move_uploaded_file($_FILES['uploaded_file']['tmp_name'], $target)) {
    ...
    $sql="INSERT INTO report_chats(uploaded_file, message, date_time, adv_id)
...
<form class="search-form">
  ...
  <div id="side-menu" class="side-nav">
	...
	<a href="student_mail.php">Email</a>
  ...
  <tr> 
    ...
    <form method="post" name="formUserReg" id="formUserReg" action="committee_report_chat.php" enctype="multipart/form-data" >
    <?php if (isset($errors)) 
        { 
        ?>
	    <p><?php echo $errors; ?></p>
	...
	<tbody>
		...
		$message = mysqli_query($con, "SELECT * FROM report_chats where adv_id=$user_id");
