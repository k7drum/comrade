...
if (isset($_POST['Btnsubmit']))
   ...
   $sql = "INSERT INTO uml_evaluation (A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, total, semester_year, student_id )
             VALUES('$A', '$B', '$C', '$D', '$E', '$F', '$G', '$H', '$I', '$J', '$K', '$L', '$M', '$N', '$O', '$P', '$total', '$semester_year', '$student_id')";
...
<div id="main">
        ...
        <option>Spring 2018</option>
            ...
            <th colspan="4" align="right">Use Case Diagram</th>
            <tr><td colspan="4">General Use Case</td></tr>
            <tr>
            ...
            <tr><td colspan="4">Partial Use Case</td></tr>
            <tr>
            ...
            <tr> <td colspan="4">System Boundary</td></tr>
            <tr>
            ...
            <tr><td colspan="4">Include Relationship</td></tr>
            <tr>
            ...
            <tr> <td colspan="4">Extends Relationship</td></tr>
            <tr>
            ...
            <tr> <td colspan="4">Generalization Relationship</td></tr>
            <tr>
            ...
            <th colspan="4">Activity Diagram</th>
            <tr> <td colspan="4">Swimlane</td></tr>
            <tr>
            ...
            <tr> <td colspan="4">Fork/Join</td></tr>
            <tr>
            ...
            <tr> <td colspan="4">Normal Flow</td></tr>
            <tr>
            ...
            <tr> <td colspan="4">Alternative Flow</td></tr>
            <tr>
            ...
            <th colspan="4">Use Case Templates</th>
            ...
            <tr> <td colspan="4">Numbering</td></tr>
            <tr>
            ...
            <th colspan="4">Domain Class Diagram</th>
            <tr> <td colspan="4">Completeness</td></tr>
            <tr>
            ...
            <th colspan="4">Interface Sketches</th>
            <tr> <td colspan="4">Completeness</td></tr>
            <tr>
            <td> <input type="radio" name ="O" value = "4"     /></td>
            <td> <input type="radio" name ="O" value = "3"     /></td>
            <td> <input type="radio" name ="O" value = "2"     /></td>
            <td> <input type="radio" name ="O" value = "1"     /></td>    
            </tr>

            <th colspan="4">Project Management Plan & Gantt Chart</th>
            <tr> <td colspan="4">Completeness</td></tr>
            <tr>
            <td> <input type="radio" name ="P" value = "4"     /></td>
            <td> <input type="radio" name ="P" value = "3"     /></td>
            <td> <input type="radio" name ="P" value = "2"     /></td>
