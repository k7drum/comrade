...
if(move_uploaded_file($_FILES['uploaded_file']['tmp_name'], $target)) {
    ...
    $sql="INSERT INTO report_chats(uploaded_file, message, date_time,student_id)
...
<body>
  ...
  <tr> 
    ...
    <form method="post" name="formUserReg" id="formUserReg" action="report.php" enctype="multipart/form-data" >
    <?php if (isset($errors)) 
        { 
        ?>
	    <p><?php echo $errors; ?></p>
	...
	<tbody>
		<?php 
		// select all report_chats if page is visited or refreshed
		$message = mysqli_query($con, "SELECT * FROM report_chats where student_id=$user_id");
